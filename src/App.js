    ...
    <div className="cv">
      ...
      <div>
        ...
        <div>
          ...
          <div>STELLR一个是对微软，谷歌， Office365等售卖云服务的B端平台。</div>
          <div>系统包含：用户管理，报表分析，设备管理，消息管理，埋点等。</div>
          <div>
            项目采用 Dva(基于React，Redux，React-Router) 为脚手架，
            在其基础上集成了 immutable，eslint，react-intl，以及公司封装的
          ...
          <ul>
            ...
            <li>在滚动加载中使用虚拟列表解决长列表性能问题</li>
            <li>解决轮询时，正在输入框内输入的内容被自动清除</li>
